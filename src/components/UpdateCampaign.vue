<template>
	<div id="campaigns" class="container">
		<div class="main container">
			<h1 class="page-header text-center"> Update This Campaign </h1>
			<!-- <h4 class="text-center"> Create a campaign for yourself or your candidate</h4> -->
			<div>
				<form v-on:submit="updateCampaign">
					...
					<!--  -->
					<!--  -->
					<button type="submit" v-on:click="updateCampaign" class="btn btn-success create ">UPDATE</button>
...
<script>
    ...
    this.axios.get(this.api).then(response => {
      ...
      this.fname = this.item.firstname;
      this.fund = this.item.fund;
      this.gender = this.item.gender;
      this.image = this.item.image;
      this.lname = this.item.lastname;
      this.polparty = this.item.party;
      this.office = this.item.position;
