				...
				<div class="row">
					...
					<div class="col-4">
						...
						<div class="contribution-stats__main">
							...
							<div class="progress progress-rounded m-tiny" title="10%">
								...
								<div class="edose">
									...
									<div class=".endose-div">
										<form v-on:submit="addEndorsment">
											...
											<!-- <button></button> -->
											<br>
											<button type="submit" v-on:click="addEndorsment" class="btn btn-success btn-endose" style="float:right;"> ENDORSE</button>
										</form>
									</div>
								</div>
								<br>
								...
								<div class="card card-body bg-light">
									...
									<div class="form-row">
										...
										<div class="col-md-6 mb-6">
											...
											<input type="text" v-model="lname" class="form-control" id="ln" placeholder="Last name" required> </div>
									</div>
									<!-- Alias Email row -->
									<div class="form-row">
	...
	export default {
		...
		data() {
			return {
				...
				items: [{
					name: "israel",
					message: "I endorse you"
				}, {
					name: "Tomi",
					message: "I Comfirm you"
				}, {
					name: "Ibrahim",
					message: "I Vote you"
				}, ],
